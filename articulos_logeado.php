                ...
                <div class="menu">
                    ...
                    <nav class="contenedor_lista">
                        <ul class="lista1">
                            ...
                            <li><a href="#" id="selected">Artículos</a></li>
        ...
        <div class="body__Page">
            ...
            <div class="container__article">
                ...
                <div class="box__article">
                        ...
                        <p style=""><?php echo$obj2->precio." $$";?></p>
                    ...
                    <div>
                        ...
                        <div class="centrar">
                            <h4 style="text-transform: uppercase;"><?php echo $obj2->nombre;?></h4>
                        </div>   
                    </div>  

                                    <form class="centrar" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                        <button type="submit" name="detalles1" value="<?php echo $obj2->id; ?>">Detalles </button>
                                    </form>
