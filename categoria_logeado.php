            ...
            <div class="container__menu">
                <div class="menu">
                    ...
                    <nav class="contenedor_lista">
                        <ul class="lista1">
                            <li clase="icon__home">
                                <a href="index_logeado.php" class="ic_a"><spam class="spam_1"><?php echo "$nombre" ?></spam></a>
                                
                            </li>
                            <li><a href="servicios_logeado.php">¿QUIENES SOMOS?</a>
                            </li>
                            <li style="background:#0074C7; transform: scale(1.1);"><a href="categoria_logeado_menu.php">Categorias</a>
                                <ul class="sub_list">
                        ...
                        <ul class="lista2">
                            ...
                            <li class="login_icon">
                                ...
                                <ul class="sub_list1">
                                    ...
                                    <div>
                                        <li >
                                            <a href="cerrar_sesion.php" class="cerrar_sesion_texto">Cerrar sesion</a>
                                        </li>
                                    </div>
...
<div class="texto_titulo">
                ...
                <?php
                    $sql4 = "SELECT nombre FROM categoria where id=$idCate"; 
                    $rs4 = pg_query( $conexion, $sql4 );
                    // Recorrer los datos de la tabla y mostrar los datos:
                    $obj4 = pg_fetch_object($rs4);

                ?>
            <h4 style="text-transform: uppercase;"><?php echo $obj4->nombre;?></h4>
        ...
        <div class="body__Page">
            <div class="container__article">
                ...
                // Definir variable e inicializar con valores vacio
                    $sql8 = "SELECT * FROM producto where idCategoria=$idCate";
                    // Ejecutar la consulta:
                    $rs8 = pg_query( $conexion, $sql8 );
                    while(  $obj8 = pg_fetch_object($rs8)){?>

                <div class="box__article">
                        
                        <p style=""><?php echo $obj8->precio." $$";?></p>

                    
                    
                    <div class="centrar_imagen">
                        <img src="<?php echo $obj8->imagen;?>" alt="">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="centrar">
                            <h4 style="text-transform: uppercase;"><?php echo $obj8->nombre;?></h4>
                            <form class="frmRegistro" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                <button  type="submit" name="detalles3" value="<?php echo $obj8->id; ?>"> Detalles</button>
                            </form>
                        </div>  
                    </div>  
