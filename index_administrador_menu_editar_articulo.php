<?php
    ...
    include_once "code-register_administrador_editar_articulo.php";
        ...
        <div class="container-all">
            ...
            <div class="ctn-form">
                ...
                <form class="frmRegistro" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" name="categoria" value="<?php echo $nombreCate; ?>" list="listaCategorias">
                    
                    
                    <label>Nombre del artículo</label>
                    <input type="text" name="nombre" value="<?php echo $nombrearticulo; ?>">
                    

                    <label>Descripcion del Articulo</label>
                    <textarea style="height:100px ;" class="input" type="text" name="descripcion"><?php echo $descripcionarticulo; ?></textarea>
                    
                    <label>Precio</label>
                    <input class="input_css" type="number" value="<?php echo $precioarticulo;?>" name="precio" step="0.01" >
                    
                    
                    <label>Cantidad</label>
                    <input class="input_css" type="number" value="<?php echo $cantidadarticulo;?>" name="cantidad" step="1" >
                    ...
                    <input class="enviar" type="submit"  value="Actualizar artículo">
