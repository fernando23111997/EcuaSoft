                ...
                <div class="menu">
                    ...
                    <nav class="contenedor_lista">
                        <ul class="lista1">
                            ...
                            <li style="background:#0074C7; transform: scale(1.1);"><a href="categoria_menu.php">Categorias</a>
                                <ul class="sub_list">
                                    ...
                                    <form class="frmRegistro" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                        ...
                                        while( $obj1 = pg_fetch_object($rs1) ){?>
                                            <li>
                                                <a>
                                                    <button type="submit" name="categoriaa" class="fila2"  value="<?php echo $obj1->id; ?>"> 
                ...
                <div class="box__article">
                    ...
                    <div>
                        ...
                        <div class="centrar">
                            ...
                            <form class="frmRegistro" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                <button  type="submit" name="detalles4" value="<?php echo $obj8->id; ?>"> Detalles</button>
                            </form>
                        </div>  
                    </div>  
