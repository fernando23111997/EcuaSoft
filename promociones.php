                ...
                <div class="menu">
                    ...
                    <nav class="contenedor_lista">
                        <ul class="lista1">
                            ...
                            <li><a href="#" id="selected">Promociones</a></li>
...
<!--INFORMCACION EN FILAS-->    
        ...
        <div class="body__Page">
            <div class="container__article">
                <?php
                $sql2 = "SELECT * FROM producto Where idpromocion!=0;"; 
                ...
                <div class="box__article">
                        ...
                        <?php
                            $sql4 = "SELECT descuento FROM promocionproducto where id=$obj2->idpromocion"; 
                            $rs4 = pg_query( $conexion, $sql4 );
                            // Recorrer los datos de la tabla y mostrar los datos:
                            $obj4 = pg_fetch_object($rs4);

                        ?>
                    <div class="descuento_promocion">
                    ...
                    <form class="centrar" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <button  type="submit" name="detalless" value="<?php echo $obj2->id; ?>"> Detalles</button>
                    </form>
                </div>
                <?php
                } 
