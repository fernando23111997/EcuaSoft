...
<body id="body">
    ...
    <h1 class="title">Lista de usuarios registrados en la pagina</h1>
        ...
        <table class="tabla-categoria">
            <thead class="color_encabezado">
                <tr id="ocultar-separador">
                    ...
                    <th  class="borde-encabezado"><h1 class="encabezado_tabla_letra">Nombre de Usuario</h1></th>
                    <th  class="borde-encabezado"><h1 class="encabezado_tabla_letra">Correo</h1></th>
                    <th  class="borde-encabezado"><h1 class="encabezado_tabla_letra">Fecha</h1></th>
                </tr>
            </thead>
            <tbody>
            <p style=" color:brown"><?php echo $numero_producto_err; ?>.....</p>
                ...
                $rs1 = pg_query( $conexion, $sql1 );
                    ...
                    <tr>
                        ...
                        <td  class="borde-encabezado color_columna2"><h1 class="fila2"><?php echo $obj1->email?></h1></td>
                        <td  class="borde-encabezado color_columna2"><h1 class="fila2"><?php echo $obj1->fecha?></h1></td>
                    </tr>
