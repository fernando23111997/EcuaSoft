<?php
    ...
    include_once "code-register_administrador_categoria.php"
    ...
    <div class="container-all">
        ...
        <div class="ctn-form">
            ...
            <form class="frmRegistro" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                ...
                <input type="file" name="imagen" id="foto" onchange="vista_preliminar(event)" required>
                <span class="msg-error"><?php echo $imagen_err; ?></span>
                <img src="" alt="" id="img-foto">
            
                <input class="enviar" type="submit"  value="Registrar categoría"> 
